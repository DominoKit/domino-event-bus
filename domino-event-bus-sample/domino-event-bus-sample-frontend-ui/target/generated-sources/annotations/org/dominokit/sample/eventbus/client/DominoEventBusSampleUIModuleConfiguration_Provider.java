...
public class DominoEventBusSampleUIModuleConfiguration_Provider implements ModuleConfigurationProvider {
  @Override
  public ModuleConfiguration get() {
    return new DominoEventBusSampleUIModuleConfiguration();
  }
}
